...
% Do not edit by hand!
\RCS$Revision: 469444 $
\RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/notes/AN-18-119/trunk/AN-18-119.tex $
\RCS$Id: AN-18-119.tex 469444 2018-07-23 18:46:51Z dleonsil $
%%%%%%%%%%%%% local definitions %%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%  Title page %%%%%%%%%%%%%%%%%%%%%%%%
\cmsNoteHeader{AN-18-119} % This is over-written in the CMS environment: useful as preprint no. for export versions
% >> Title: please make sure that the non-TeX equivalent is in PDFTitle below
\title{Search for Mono-top Production in Events with One Lepton, Missing Transverse Energy, and Jets}
...
pdftitle={Search for Mono-top Production in Events with One Lepton, Missing Transverse Energy, and Jets},%
pdfsubject={CMS},%
...
\input{srcs/section_intro}
\input{srcs/section_theory}
%\input{srcs/section_data_mc}
\input{srcs/section_objects}
\input{srcs/section_selections}
%\input{srcs/section_systematic}
\input{srcs/section_signal}
\input{srcs/section_systematic}
\input{srcs/section_data_mc}
\clearpage
